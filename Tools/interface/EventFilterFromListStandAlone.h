#ifndef MitHgg_Tools_EventFilterFromListStandAlone_h
#define MitHgg_Tools_EventFilterFromListStandAlone_h
...
class EventFilterFromListStandAlone : public TObject  {
public:
  /**
   * Constructor
...
private:
  ...
  ClassDef(EventFilterFromListStandAlone, 0)
