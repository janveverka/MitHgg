...
process.inputs = cms.PSet(
    fileNames = cms.vstring(
        join('/home/mingyang/cms/hist/hgg-2013Final8TeV/merged',
             #'hgg-2013Final8TeV_s12-h125gg-gf-v7n_noskim.root')
             #'hgg-2013Final8TeV_s12-h125gg-tt-v7n_noskim.root')
             'hgg-2013Final8TeV_s12-h125gg-vbf-v7n_noskim.root')
             #'hgg-2013Final8TeV_s12-h125gg-vh-v7n_noskim.root')
        ),
    treeName  = cms.string(
