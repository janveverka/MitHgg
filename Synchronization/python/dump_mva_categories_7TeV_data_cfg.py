...
_input_base = '/home/mingyang/cms/hist/hgg-2013Final7TeV/merged'
...
process.inputs = cms.PSet(
    fileNames = cms.vstring() + [
        join(_input_base, 'hgg-2013Final7TeV_r11%s-pho-j21-v1_noskim.root' % r) 
        for r in 'ab'
        ],
    treeName  = cms.string(
...
process.dump = cms.PSet(
    ...
    ## 7TeV untagged / diphoton-BDT categories by Josh from 21 November 2013
    diphotonBdtBoundaries = cms.vdouble(0.93, 0.85, 0.70, 0.19),
    dijetBdtBoundaries    = cms.vdouble(),
    ## Updated 7TeV dijet / combined-BDT categories by Josh from 3 December 2013
