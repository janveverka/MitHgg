...
//   * mu1_phi, ele1_phi, ele2_*, mu2_*, numJets, numBJets
#include <stdio.h>
#include <iostream>
#include <sstream>
#include "TMath.h"
...
// enum Categories {kIncl0      = 0, kIncl1, kIncl2, kIncl3, kIncl4,
...
//              TString dirName = "PhotonTreeWriterPresel",
              TString dirName = "PhotonTreeWriterPreselNoSmear",
              bool smearMassError = true
              );
template <class T>
