...
barrel_variables = common_variables + '''
    ph.e5x5seed/ph.eseed
    ph.ietaseed
    ph.iphiseed%18
    ph.ietaseed%5
    ph.iphiseed%2
    (abs(ph.ietaseed)<=25)*(ph.ietaseed%25)+(abs(ph.ietaseed)>25)*((ph.ietaseed-25*abs(ph.ietaseed)/ph.ietaseed)%20)
    ph.iphiseed%20
    ph.etacryseed
    ph.phicryseed
    ph.etaseed
...
endcap_variables = common_variables + '''
    ph.scpse/ph.scrawe
    ph.etaseed
    ph.sceta
    ph.phiseed
...
input_file_name = '/home/mingyang/cms/hist/hgg-2013Final7TeV_0/merged/hgg-2013Final7TeV_s11-h120gg-vh-lv3_noskim.root'
