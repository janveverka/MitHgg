...
//--------------------------------------------------------------------------------------------------
void runHgg2013Final_8TeV_pickevents(const char *fileset    = "0000",
			  ...
			  int         nEvents    = -1)
{
  ...
  photpreselinverteleveto->SetTrailingPtMin(20.);
   ...
   phottreecic->SetVerbosityLevel(200);
   ...
   phottreepresel->SetVerbosityLevel(95);
...
//   ana->AddDataset(d);
  ...
  /// VH lep and ttH deficit events
/*  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12b-dph-j22-v1/"
               "BA6F366A-116D-E211-8362-0026189438E1.root"); // 194691:80:63517077
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12b-dph-j22-v1/"
               "E8047264-3B6D-E211-BAA5-0026189437F5.root"); // 195397:1172:1361890417
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12b-dph-j22-v1/"
               "3AD29621-1C6D-E211-9EB7-0026189438D2.root"); // 195950:188:197022547
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "B802FEBC-2F71-E211-8D0B-00261894387D.root"); // 198969  341  449378235
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "464C5B08-9770-E211-B580-002354EF3BE2.root"); // 199008  294  369441614
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "E2F8FB06-DC70-E211-B730-003048679244.root"); // 199021 1393 1522682932
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "DC7DB42E-5E71-E211-98E4-00261894391F.root"); // 199832  227  280392762
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "BC4184B7-B270-E211-AB38-003048679010.root"); // 200229  506  537326223
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "EEF3A1EC-2571-E211-9772-003048FFCB9E.root"); // 201202   51   49882246
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "E40562A0-1D71-E211-8116-0026189437FA.root"); // 202504   84   45496025
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "DCF115DA-A382-E211-951D-00266CFAE518.root"); // 204601  218  291520084
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "D251C2DD-C884-E211-9D28-00A0D1EE968C.root"); // 206331  106   93829188
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "50A9A2B5-0583-E211-A8E2-00266CFAE050.root"); // 206446  784 1072391444
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "5C867B4C-0882-E211-9266-00A0D1EE8ECC.root"); // 207231  402  619292470
  /// VH lep and ttH excess events.
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12b-dph-j22-v1/"
               "80CFFBE2-5B6E-E211-8C67-00261894396E.root"); // 195774 311
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "AC0BFA19-4371-E211-A320-003048679180.root"); // 199864  89
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "C81285C2-9C84-E211-9DEE-00A0D1EEF4F8.root"); // 206401 127
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "50A9A2B5-0583-E211-A8E2-00266CFAE050.root"); // 206446 784
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "26183D76-A782-E211-8B42-00A0D1EE8DFC.root"); // 206940 248
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "B232744E-5984-E211-BFEF-00266CFAE074.root"); // 207269 182
  /// VH lep excess event with a ghost electron
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12b-dph-j22-v1/"
               "48772BDD-186D-E211-83BA-00261894388D.root"); // 196250  64
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"  
               "AC0BFA19-4371-E211-A320-003048679180.root");
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "C69A6C9C-1D71-E211-B0FC-0026189438A2.root");
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "58A00E18-D383-E211-BE7B-00266CF9BCC4.root");
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "C81285C2-9C84-E211-9DEE-00A0D1EEF4F8.root");
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "94A7A5EE-8782-E211-90B7-848F69FD4553.root");
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12d-dph-j22-v1/"
               "70983792-3384-E211-803F-00266CF9C0AC.root");*/
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/029/r12c-dph-j22-v1/"
               "E2F8FB06-DC70-E211-B730-003048679244.root"); // 199021:1393:1522682932
