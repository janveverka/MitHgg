...
//--------------------------------------------------------------------------------------------------
void runHgg2013Final_7TeV_pickevents(const char *fileset    = "0000",
			  ...
			  int         nEvents    = 1000)
{
 ...
 MuonIDMod* softMuonIdMod = new MuonIDMod;
  ...
  photpreselinverteleveto->SetTrailingPtMin(20.);
   ...
   phottreepresel->SetVerbosityLevel(99);
  ...
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/031/r11a-pho-j21-v1/"
               "22EFCDC4-78E0-E211-9198-001E67397CCE.root"); // 172952:1118:1279068855
  ana->AddFile("/mnt/hadoop/cms/store/user/paus/filefi/031/r11b-pho-j21-v1/"
               "2C97CF56-0FE1-E211-8AE1-FA163E5F981D.root"); // 177730:1125:1828549350
