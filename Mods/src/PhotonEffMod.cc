...
void PhotonEffMod::Process()
{
  ...
  Float_t fillEvent[] = { (Float_t) fIsData,
			  ...
			  (Float_t) _mu1->E(),
			  (Float_t) _mu1->Pz(),
			  (Float_t) (_mu1->IsoR03SumPt() + _mu1->IsoR03EmEt() + _mu1->IsoR03HadEt()),
			  (Float_t) _mu1->IsoR03SumPt(),
			  (Float_t) _mu1->IsoR03EmEt(),
			  (Float_t) _mu1->IsoR03HadEt(),
			  (Float_t) _mu1->HadEnergy(),
			  (Float_t) _mu1->HadS9Energy(),
			  (Float_t) _mu1->EmEnergy(),
			  (Float_t) _mu1->EmS9Energy(),
			  (Float_t) _mu1->HoEnergy(),
			  (Float_t) _mu1->HoS9Energy(),
			  (Float_t) _mu2->Pt(),
			  (Float_t) _mu2->Eta(),
			  (Float_t) _mu2->Phi(),
			  (Float_t) _mu2->E(),
			  (Float_t) _mu2->Pz(),
			  (Float_t) (_mu2->IsoR03SumPt() + _mu2->IsoR03EmEt() + _mu2->IsoR03HadEt()),
			  (Float_t) _mu2->IsoR03SumPt(),
			  (Float_t) _mu2->IsoR03EmEt(),
			  (Float_t) _mu2->IsoR03HadEt(),
			  (Float_t) _mu2->HadEnergy(),
			  (Float_t) _mu2->HadS9Energy(),
			  (Float_t) _mu2->EmEnergy(),
			  (Float_t) _mu2->EmS9Energy(),
			  (Float_t) _mu2->HoEnergy(),
			  (Float_t) _mu2->HoS9Energy(),
			  (Float_t) closeSCEt,
			  (Float_t) closeSCEta,
			  (Float_t) closeSCPhi,
			  (Float_t) closeSCE,
			  ...
			  (Float_t) hardPhEiso,
			  (Float_t) hardPhHiso,
			  (Float_t) _muCloseToClose->Pt(),
			  (Float_t) _muCloseToClose->Eta(),
			  (Float_t) _muCloseToClose->Phi(),
			  (Float_t) _muCloseToClose->E(),
			  (Float_t) (_muCloseToClose->IsoR03SumPt() + _muCloseToClose->IsoR03EmEt() + _muCloseToClose->IsoR03HadEt()),
			  (Float_t) _muCloseToClose->IsoR03SumPt(),
			  (Float_t) _muCloseToClose->IsoR03EmEt(),
			  (Float_t) _muCloseToClose->IsoR03HadEt(),
			  (Float_t) _muCloseToClose->HadEnergy(),
			  (Float_t) _muCloseToClose->HadS9Energy(),
			  (Float_t) _muCloseToClose->EmEnergy(),
			  (Float_t) _muCloseToClose->EmS9Energy(),
			  (Float_t) _muCloseToClose->HoEnergy(),
			  (Float_t) _muCloseToClose->HoS9Energy(),
			  (Float_t) _muCloseToHard->Pt(),
			  (Float_t) _muCloseToHard->Eta(),
			  (Float_t) _muCloseToHard->Phi(),
			  (Float_t) _muCloseToHard->E(),
			  (Float_t) (_muCloseToHard->IsoR03SumPt() + _muCloseToHard->IsoR03EmEt() + _muCloseToHard->IsoR03HadEt()),
			  (Float_t) _muCloseToHard->IsoR03SumPt(),
			  (Float_t) _muCloseToHard->IsoR03EmEt(),
			  (Float_t) _muCloseToHard->IsoR03HadEt(),
			  (Float_t) _muCloseToHard->HadEnergy(),
			  (Float_t) _muCloseToHard->HadS9Energy(),
			  (Float_t) _muCloseToHard->EmEnergy(),
			  (Float_t) _muCloseToHard->EmS9Energy(),
			  (Float_t) _muCloseToHard->HoEnergy(),
			  (Float_t) _muCloseToHard->HoS9Energy(),
			  (Float_t) muMass,
			  (Float_t) closeMass,
			  (Float_t) hardMass,
			  (Float_t) numPU,
