// $Id: HGGModSimple.cc,v 1.3 2012/04/17 16:35:29 fabstoec Exp $
...
void HGGModSimple::FillDiphotonTree(const Photon *g1, const Photon *g2) const {
  ...
  Float_t fillGen[] = { (Float_t) hvector.Pt(),
			...
			(Float_t) ngenvtx,
			(Float_t) passelectronveto1,
			(Float_t) passelectronveto2,
			(Float_t) passelectronvetoconv1,
			(Float_t) passelectronvetoconv2,
			(Float_t) matchtrigger1,
			(Float_t) matchtrigger2,
			(Float_t) trkisonopv1,
			(Float_t) trkisonopv2,
			(Float_t) passconvid1,
			(Float_t) passconvid2,
			(Float_t) rho,
			(Float_t) genmatchvtx.Z(),
			(Float_t) convvtx.Z(),
			(Float_t) convmatchvtx.Z(),
			(Float_t) hvectorgen.M(),
			(Float_t) hvectorgenmatch.M(),
			(Float_t) hvectorconv.M(),
			(Float_t) hvectorconvmatch.M(),
			(Float_t) hvectorvtx.M(),
			(Float_t) hvectorbsvtx.M()
  };
