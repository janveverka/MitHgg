...
void HGGMod::FillDiphotonTree(const Photon *g1, const Photon *g2) const {
  ...
  for (UInt_t ivtx=0; ivtx<fPrimaryVertex->GetEntries(); ++ivtx) {
    ...
    Float_t fillVtx[] = { (Float_t) rvtx->Position().X(),
			   (Float_t)  rvtx->Position().Y(),
			   (Float_t)  rvtx->Position().Z(),
			   (Float_t)  rvtx->XErr(),
			   (Float_t)  rvtx->YErr(),
			   (Float_t)  rvtx->ZErr(),
			   (Float_t)  rvtx->Ndof(),
			   ...
			   (Float_t)  sumpt,
                          ...
                          (Float_t) pztot,
                          (Float_t) genhpt,
                          (Float_t) hvectorrvtx.Pt(),
                          (Float_t) hvectorrvtx.Eta(),
                          (Float_t) hvectorrvtx.Phi(),
                          (Float_t) hvectorrvtx.M()
    };
  ...
  Float_t fillGen[] = { (Float_t) hvector.Pt(),
                        (Float_t) hvector.Eta(),
                        (Float_t) hvector.Phi(),
                        (Float_t) hvector.M(),
                        (Float_t) hvector.E(),
                        ...
                        (Float_t) g2boost.Py(),
                        (Float_t) g2boost.Pz(),
                        (Float_t) g1->HasPixelSeed(),
                        (Float_t) g2->HasPixelSeed(),
                        ...
                        (Float_t) convp1,
                        (Float_t) vtxzconv1,
                        (Float_t) vtxzconverr1,
                        (Float_t) vtxzconvsc1,
                        (Float_t) vtxzconvscconstraint1,
                        (Float_t) vtxzconvscconstrainterr1,                          
                        (Float_t) convpos1.X(),
                        (Float_t) convpos1.Y(),
                        (Float_t) convpos1.Z(),
                        (Float_t) convpos1.Rho(),
                        (Float_t) convpos1.Phi(),
                        (Float_t) ept11,
                        (Float_t) ept21,
                        ...
                        (Float_t) convp2,
                        (Float_t) vtxzconv2,
                        (Float_t) vtxzconverr2,
                        (Float_t) vtxzconvsc2,
                        (Float_t) vtxzconvscconstraint2,
                        (Float_t) vtxzconvscconstrainterr2,                          
                        (Float_t) convpos2.X(),
                        (Float_t) convpos2.Y(),
                        (Float_t) convpos2.Z(),
                        (Float_t) convpos2.Rho(),
                        (Float_t) convpos2.Phi(),
                        (Float_t) ept12,
                        (Float_t) ept22,
                        (Float_t) cosdalpha1,
                        (Float_t) cosdalpha2,
                        ...
                        (Float_t) eoverp1,
                        (Float_t) etoverptdir1,
                        (Float_t) etoverptvtx1,
                        (Float_t) deta1,
                        (Float_t) dphi1,
                        (Float_t) detacor1,
                        (Float_t) dphicor1,
                        ...
                        (Float_t) dphiconv1,
                        (Float_t) eoverp2,
                        (Float_t) etoverptdir2,
                        (Float_t) etoverptvtx2,                          
                        (Float_t) deta2,
                        (Float_t) dphi2,
                        (Float_t) detacor2,
                        (Float_t) dphicor2, 
                        ...
                        (Float_t) hmassvtx,
                        (Float_t) hmassgenvtx,
                        (Float_t) hmassbestvtx,
                        (Float_t) hmassbestvtxc,
                        (Float_t) hmassbestvtxct,
                        (Float_t) hmassbestvtxt,
                        (Float_t) hmassbestvtxtc,
                        (Float_t) hmassbsvtx,
                        (Float_t) genpt1,
                        (Float_t) geneta1,
                        (Float_t) genphi1,
                        ...
                        (Float_t) genhy,
                        (Float_t) genhz,
                        (Float_t) fPrimaryVertex->At(0)->X(),
                        (Float_t) fPrimaryVertex->At(0)->Y(),
                        (Float_t) fPrimaryVertex->At(0)->Z(),
                        (Float_t) fBeamSpot->At(0)->X(),
                        (Float_t) fBeamSpot->At(0)->Y(),
                        (Float_t) fBeamSpot->At(0)->Z(),
                        (Float_t) vtxcorz1,
                        (Float_t) vtxcorz2,
                        (Float_t) prob1,
                        (Float_t) prob2,
                        (Float_t) nhitsbeforevtx11,
                        (Float_t) nhitsbeforevtx21,
                        (Float_t) nhitsbeforevtx12,
                        (Float_t) nhitsbeforevtx22,
                        (Float_t) vtxcor.Z(),
                        (Float_t) vtxcorct.Z(),
                        (Float_t) vtxcort.Z(),
                        (Float_t) vtxcortc.Z(),
                        ...
                        (Float_t) multivtx.Z(),
                        (Float_t) deltarboost,
                        (Float_t) cosdthetaboost,
                        (Float_t) besttracknpixelhits,
                        (Float_t) besttracknstereohits,
                        (Float_t) besttrackdzerr,
                        (Float_t) besttrackdeta,
                        (Float_t) besttrackdphi,
                        (Float_t) bestconvdeta,
                        (Float_t) bestconvdphi,
                        (Float_t) nvtx,
                        (Float_t) ngoodvtx,
                        (Float_t) g1->IsConverted(),
                        (Float_t) g2->IsConverted(),
                        (Float_t) MathUtils::DeltaR(g1,g2),
                        (Float_t) g1->R9(),
                        (Float_t) g1->HadOverEm(),
                        (Float_t) g1->CoviEtaiEta(),
                        (Float_t) g1->SCluster()->Seed()->CoviPhiiPhi(),
                        (Float_t) g1->SCluster()->Seed()->CoviEtaiPhi(),
                        (Float_t) g1->IsEB(),
                        (Float_t) g1->IsEE(),
                        (Float_t) g1->HollowConeTrkIsoDr04(),
                        (Float_t) g1->EcalRecHitIsoDr04(),
                        (Float_t) g1->HcalTowerSumEtDr04(),
                        (Float_t) g2->R9(),
                        (Float_t) g2->HadOverEm(),
                        (Float_t) g2->CoviEtaiEta(),
                        (Float_t) g2->SCluster()->Seed()->CoviPhiiPhi(),
                        (Float_t) g2->SCluster()->Seed()->CoviEtaiPhi(),
                        (Float_t) g2->IsEB(),
                        (Float_t) g2->IsEE(),
                        (Float_t) g2->HollowConeTrkIsoDr04(),
                        (Float_t) g2->EcalRecHitIsoDr04(),
                        (Float_t) g2->HcalTowerSumEtDr04(),
                        (Float_t) jetpt1,
                        (Float_t) jeteta1,
                        (Float_t) jetphi1,
                        (Float_t) jete1,
                        ...
                        (Float_t) corjete2,
                        (Float_t) ngenvtx,
                        (Float_t) (vtxmulti == closestVtx),
                        (Float_t) haselectron1,
                        (Float_t) isecaldriven1,
                        (Float_t) istrackerdriven1,
                        (Float_t) expectedhitsinner1,
                        (Float_t) haselectronconv1,
                        (Float_t) electronconvnhitsbeforevtx11,
                        (Float_t) electronconvnhitsbeforevtx21,
                        (Float_t) haselectron2,
                        (Float_t) isecaldriven2,
                        (Float_t) istrackerdriven2,
                        (Float_t) expectedhitsinner2,
                        (Float_t) haselectronconv2,
                        (Float_t) electronconvnhitsbeforevtx12,
                        (Float_t) electronconvnhitsbeforevtx22,                          
                        (Float_t) g1->SCluster()->Energy(),
                        (Float_t) g1->SCluster()->Eta(),
                        (Float_t) g2->SCluster()->Energy(),
                        (Float_t) g2->SCluster()->Eta(),
                        (Float_t) ptgenpdg1,
                        (Float_t) ptgenpdgm1,
                        (Float_t) ptgenpdg2,
                        (Float_t) ptgenpdgm2
