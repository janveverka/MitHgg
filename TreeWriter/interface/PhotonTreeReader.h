// MitHgg/TreeWriter/PhotonTreeReader.h - PhotonTreeReader class
// Holds a pointer to the PhotonTreeReader and sets branch addresses to the
// PhotonTreeWriterDiphotonEvent members using its reflection information.
// Author: J. Veverka
//-----------------------------------------------------------------------------
#ifndef MITHGG_TREEWRITER_PHOTONTREEREADER_H
#define MITHGG_TREEWRITER_PHOTONTREEREADER_H
...
// Provides mithep::PhotonTreeReaderWriterDiphotonEvent
...
namespace mithep
{
  namespace hgg
  {
    class PhotonTreeReader : public TObject, public PhotonTreeWriterDiphotonEvent
    {
      public:
        PhotonTreeReader (TTree* iTree);
        virtual ~PhotonTreeReader();
      ...
      protected:
        ...
        ClassDef(PhotonTreeReader, 0)

    }; // PhotonTreeReader
  } // hgg
} // mithep

#endif // MITHGG_TREEWRITER_PHOTONTREEREADER_H
